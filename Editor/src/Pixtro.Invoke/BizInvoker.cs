...
namespace Pixtro.Invoke
{
	public static class BizInvoker
	{
		...
		/// <exception cref="InvalidOperationException"><see cref="GetInvoker{T}(Pixtro.Common.IImportResolver,Pixtro.Common.IMonitor,Pixtro.Invoke.ICallingConventionAdapter)"/> overload previously called with <paramref name="dll"/></exception>
