namespace Pixtro.Client.Editor.CustomControls
{
	partial class MsgBox
	{
		...
		private void InitializeComponent()
		{
			...
			this.messageLbl = new Pixtro.WinForms.Controls.LocLabelEx();
		...
		private Pixtro.WinForms.Controls.LocLabelEx messageLbl;
