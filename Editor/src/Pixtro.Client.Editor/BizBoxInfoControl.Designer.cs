namespace Pixtro.Client.Editor
{
	partial class BizBoxInfoControl
	{
		...
		{
			this.CoreNameLabel = new Pixtro.WinForms.Controls.LocLabelEx();
			this.CoreAuthorLabel = new Pixtro.WinForms.Controls.LocLabelEx();
			this.CorePortedLabel = new Pixtro.WinForms.Controls.LocLabelEx();
		...
		private Pixtro.WinForms.Controls.LocLabelEx CoreNameLabel;
		private Pixtro.WinForms.Controls.LocLabelEx CoreAuthorLabel;
		private Pixtro.WinForms.Controls.LocLabelEx CorePortedLabel;
