namespace Pixtro.Client.Editor
{
	partial class PlatformChooser
	{
		...
		private void InitializeComponent()
		{
			...
			this.ExtensionLabel = new Pixtro.WinForms.Controls.LocLabelEx();
			this.RomSizeLabel = new Pixtro.WinForms.Controls.LocLabelEx();
    ...
    "e as to which platform should be chosen.";
        ...
        private Pixtro.WinForms.Controls.LocLabelEx ExtensionLabel;
        private Pixtro.WinForms.Controls.LocLabelEx RomSizeLabel;
