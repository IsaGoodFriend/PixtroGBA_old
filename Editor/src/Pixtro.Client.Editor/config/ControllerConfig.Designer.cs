namespace Pixtro.Client.Editor
{
	partial class ControllerConfig
	{
		...
		private void InitializeComponent()
		{
			...
			this.testToolStripMenuItem = new Pixtro.WinForms.Controls.ToolStripMenuItemEx();
			this.loadDefaultsToolStripMenuItem = new Pixtro.WinForms.Controls.ToolStripMenuItemEx();
			this.clearToolStripMenuItem = new Pixtro.WinForms.Controls.ToolStripMenuItemEx();
			this.toolTip1 = new System.Windows.Forms.ToolTip(this.components);
			this.label3 = new Pixtro.WinForms.Controls.LocLabelEx();
			this.label2 = new Pixtro.WinForms.Controls.LocLabelEx();
			this.label38 = new Pixtro.WinForms.Controls.LocLabelEx();
			this.btnMisc = new Pixtro.Client.Editor.MenuButton();
		...
		private MenuButton btnMisc;
				private Pixtro.WinForms.Controls.ToolStripMenuItemEx testToolStripMenuItem;
				private Pixtro.WinForms.Controls.ToolStripMenuItemEx loadDefaultsToolStripMenuItem;
				private Pixtro.WinForms.Controls.ToolStripMenuItemEx clearToolStripMenuItem;
				private Pixtro.WinForms.Controls.LocLabelEx label3;
				private Pixtro.WinForms.Controls.LocLabelEx label2;
				private Pixtro.WinForms.Controls.LocLabelEx label38;
