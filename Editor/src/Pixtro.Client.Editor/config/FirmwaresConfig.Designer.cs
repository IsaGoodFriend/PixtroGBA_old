...
namespace Pixtro.Client.Editor
{
    partial class FirmwaresConfig
    {
        ...
        private void InitializeComponent()
        {
			...
			this.tsmiSetCustomization = new Pixtro.WinForms.Controls.ToolStripMenuItemEx();
			this.tsmiClearCustomization = new Pixtro.WinForms.Controls.ToolStripMenuItemEx();
			this.tsmiInfo = new Pixtro.WinForms.Controls.ToolStripMenuItemEx();
			this.tsmiCopy = new Pixtro.WinForms.Controls.ToolStripMenuItemEx();
			...
			this.ResumeLayout(false);
				...
				private Pixtro.WinForms.Controls.ToolStripMenuItemEx tsmiSetCustomization;
				private Pixtro.WinForms.Controls.ToolStripMenuItemEx tsmiClearCustomization;
				private Pixtro.WinForms.Controls.ToolStripMenuItemEx tsmiInfo;
				private Pixtro.WinForms.Controls.ToolStripMenuItemEx tsmiCopy;
