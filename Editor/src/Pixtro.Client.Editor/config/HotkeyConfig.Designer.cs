namespace Pixtro.Client.Editor
{
	partial class HotkeyConfig
	{
		...
		private void InitializeComponent()
		{
			...
			this.MiscButton = new Pixtro.Client.Editor.MenuButton();
			...
			this.clearCurrentTabToolStripMenuItem = new Pixtro.WinForms.Controls.ToolStripMenuItemEx();
			this.restoreDefaultsToolStripMenuItem = new Pixtro.WinForms.Controls.ToolStripMenuItemEx();
        ...
        private Pixtro.WinForms.Controls.LocLabelEx label1;
				...
				private Pixtro.WinForms.Controls.ToolStripMenuItemEx clearCurrentTabToolStripMenuItem;
				private Pixtro.WinForms.Controls.ToolStripMenuItemEx restoreDefaultsToolStripMenuItem;
