namespace Pixtro.Client.Editor
{
	partial class FirmwaresConfigInfo
	{
		...
		private void InitializeComponent()
		{
			...
			this.lblFirmware = new Pixtro.WinForms.Controls.LocLabelEx();
			this.lvmiOptionsContextMenuStrip = new System.Windows.Forms.ContextMenuStrip(this.components);
			this.tsmiOptionsCopy = new Pixtro.WinForms.Controls.ToolStripMenuItemEx();
		...
		public Pixtro.WinForms.Controls.LocLabelEx lblFirmware;
		private System.Windows.Forms.ContextMenuStrip lvmiOptionsContextMenuStrip;
		private Pixtro.WinForms.Controls.ToolStripMenuItemEx tsmiOptionsCopy;
