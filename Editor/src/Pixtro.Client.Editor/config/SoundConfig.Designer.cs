namespace Pixtro.Client.Editor
{
	partial class SoundConfig
	{
		...
		private void InitializeComponent()
		{
			...
			this.SoundDeviceLabel = new Pixtro.WinForms.Controls.LocLabelEx();
			this.BufferSizeLabel = new Pixtro.WinForms.Controls.LocLabelEx();
			this.BufferSizeNumeric = new System.Windows.Forms.NumericUpDown();
			this.BufferSizeUnitsLabel = new Pixtro.WinForms.Controls.LocLabelEx();
		...
		private Pixtro.WinForms.Controls.LocLabelEx SoundDeviceLabel;
		private Pixtro.WinForms.Controls.LocLabelEx BufferSizeLabel;
		private System.Windows.Forms.NumericUpDown BufferSizeNumeric;
		private Pixtro.WinForms.Controls.LocLabelEx BufferSizeUnitsLabel;
