namespace Pixtro.Client.Editor
{
	partial class ProfileConfig
	{
		...
		private void InitializeComponent()
		{
			...
			this.ProfileOptionsLabel = new Pixtro.WinForms.Controls.LocLabelEx();
			this.OtherOptions = new Pixtro.WinForms.Controls.LocLabelEx();
		...
		private Pixtro.WinForms.Controls.LocLabelEx ProfileOptionsLabel;
		private Pixtro.WinForms.Controls.LocLabelEx OtherOptions;
