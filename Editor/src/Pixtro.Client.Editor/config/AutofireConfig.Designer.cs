namespace Pixtro.Client.Editor
{
	partial class AutofireConfig
	{
		...
		{
			this.btnDialogOK = new Pixtro.WinForms.Controls.SzButtonEx();
			this.btnDialogCancel = new Pixtro.WinForms.Controls.SzButtonEx();
			this.nudPatternOn = new Pixtro.WinForms.Controls.SzNUDEx();
			this.nudPatternOff = new Pixtro.WinForms.Controls.SzNUDEx();
			this.lblPatternOn = new Pixtro.WinForms.Controls.LabelEx();
			this.lblPatternOff = new Pixtro.WinForms.Controls.LabelEx();
			this.flpDialogButtons = new Pixtro.WinForms.Controls.LocSzSingleRowFLP();
			this.flpDialog = new Pixtro.WinForms.Controls.LocSzSingleColumnFLP();
			this.flpPattern = new Pixtro.WinForms.Controls.SingleRowFLP();
			this.lblPatternDesc = new Pixtro.WinForms.Controls.LabelEx();
			this.cbConsiderLag = new Pixtro.WinForms.Controls.CheckBoxEx();
		...
		private Pixtro.WinForms.Controls.SzButtonEx btnDialogOK;
		private Pixtro.WinForms.Controls.SzButtonEx btnDialogCancel;
		private Pixtro.WinForms.Controls.SzNUDEx nudPatternOff;
		private Pixtro.WinForms.Controls.LabelEx lblPatternOn;
		private Pixtro.WinForms.Controls.LabelEx lblPatternOff;
		private Pixtro.WinForms.Controls.SingleRowFLP flpPattern;
		private Pixtro.WinForms.Controls.LocSzSingleColumnFLP flpDialog;
		private Pixtro.WinForms.Controls.LocSzSingleRowFLP flpDialogButtons;
		private Pixtro.WinForms.Controls.LabelEx lblPatternDesc;
		public Pixtro.WinForms.Controls.SzNUDEx nudPatternOn;
		private Pixtro.WinForms.Controls.CheckBoxEx cbConsiderLag;
	}
}
