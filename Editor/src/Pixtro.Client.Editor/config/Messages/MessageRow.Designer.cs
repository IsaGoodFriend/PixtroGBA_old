namespace Pixtro.Client.Editor
{
	partial class MessageRow
	{
		...
		{
            this.RowRadio = new Pixtro.WinForms.Controls.RadioButtonEx();
            this.LocationLabel = new Pixtro.WinForms.Controls.LocLabelEx();
            this.SuspendLayout();
            // 
            // RowRadio
            // 
		...
		private Pixtro.WinForms.Controls.RadioButtonEx RowRadio;
