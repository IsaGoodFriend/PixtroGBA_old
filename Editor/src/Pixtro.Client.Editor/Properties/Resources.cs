...
namespace Pixtro.Client.Editor.Properties
{
	internal static class Resources
	{
		/// <param name="embedPath">Dir separator is '<c>.</c>'. Path is relative to <c>&lt;NS></c>.</param>
		private static Bitmap ReadEmbeddedBitmapAt(string embedPath) => new Bitmap(Pixtro.Common.ReflectionCache.EmbeddedResourceStream(embedPath));
		...
		private static Icon ReadEmbeddedIcon(string filename) => new Icon(Pixtro.Common.ReflectionCache.EmbeddedResourceStream($"images.{filename}.ico"));
