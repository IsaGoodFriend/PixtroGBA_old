namespace Pixtro.Client.Editor
{
	partial class GameShark
	{
		...
		private void InitializeComponent()
		{
			...
			this.lblCheat = new Pixtro.WinForms.Controls.LocLabelEx();
			this.txtCheat = new System.Windows.Forms.TextBox();
			this.btnGo = new System.Windows.Forms.Button();
			this.lblDescription = new Pixtro.WinForms.Controls.LocLabelEx();
		...
		internal Pixtro.WinForms.Controls.LocLabelEx lblCheat;
		internal System.Windows.Forms.TextBox txtCheat;
		internal System.Windows.Forms.Button btnGo;
		private Pixtro.WinForms.Controls.LocLabelEx lblDescription;
