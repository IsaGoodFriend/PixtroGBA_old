namespace Pixtro.Client.Editor
{
	partial class LuaRegisteredFunctionsList
	{
		...
		private void InitializeComponent()
		{
			...
			this.callToolStripMenuItem = new Pixtro.WinForms.Controls.ToolStripMenuItemEx();
			this.removeToolStripMenuItem = new Pixtro.WinForms.Controls.ToolStripMenuItemEx();
		...
		private Pixtro.WinForms.Controls.ToolStripMenuItemEx callToolStripMenuItem;
		private Pixtro.WinForms.Controls.ToolStripMenuItemEx removeToolStripMenuItem;
