namespace Pixtro.Client.Editor
{
	partial class CheatEdit
	{
		...
		private void InitializeComponent()
		{
			...
			this.NameLabel = new Pixtro.WinForms.Controls.LocLabelEx();
			this.AddressLabel = new Pixtro.WinForms.Controls.LocLabelEx();
			this.AddressHexIndLabel = new Pixtro.WinForms.Controls.LocLabelEx();
			this.AddressBox = new Pixtro.Client.Editor.HexTextBox();
			this.ValueHexIndLabel = new Pixtro.WinForms.Controls.LocLabelEx();
			this.ValueLabel = new Pixtro.WinForms.Controls.LocLabelEx();
			this.CompareHexIndLabel = new Pixtro.WinForms.Controls.LocLabelEx();
			this.CompareLabel = new Pixtro.WinForms.Controls.LocLabelEx();
			this.DomainLabel = new Pixtro.WinForms.Controls.LocLabelEx();
			this.DomainDropDown = new System.Windows.Forms.ComboBox();
			this.SizeLabel = new Pixtro.WinForms.Controls.LocLabelEx();
			this.SizeDropDown = new System.Windows.Forms.ComboBox();
			this.DisplayTypeLabel = new Pixtro.WinForms.Controls.LocLabelEx();
			...
			this.CompareBox = new Pixtro.Client.Editor.WatchValueBox();
			this.ValueBox = new Pixtro.Client.Editor.WatchValueBox();
			this.CompareTypeDropDown = new System.Windows.Forms.ComboBox();
			this.CompareTypeLabel = new Pixtro.WinForms.Controls.LocLabelEx();
			this.SuspendLayout();
			// 
			// NameBox
			// 
			...
			// CompareBox
			// 
			this.CompareBox.ByteSize = Pixtro.Client.Common.WatchSize.Byte;
			...
			this.CompareBox.Type = Pixtro.Client.Common.WatchDisplayType.Hex;
			this.CompareBox.TextChanged += new System.EventHandler(this.CompareBox_TextChanged);
			// 
			// ValueBox
			// 
			this.ValueBox.ByteSize = Pixtro.Client.Common.WatchSize.Byte;
			...
			this.ValueBox.Type = Pixtro.Client.Common.WatchDisplayType.Hex;
			// 
			// CompareTypeDropDown
			// 
		...
		private Pixtro.WinForms.Controls.LocLabelEx NameLabel;
		private Pixtro.WinForms.Controls.LocLabelEx AddressLabel;
		private Pixtro.WinForms.Controls.LocLabelEx AddressHexIndLabel;
		private HexTextBox AddressBox;
		private WatchValueBox ValueBox;
		private Pixtro.WinForms.Controls.LocLabelEx ValueHexIndLabel;
		private Pixtro.WinForms.Controls.LocLabelEx ValueLabel;
		private WatchValueBox CompareBox;
		private Pixtro.WinForms.Controls.LocLabelEx CompareHexIndLabel;
		private Pixtro.WinForms.Controls.LocLabelEx CompareLabel;
		private Pixtro.WinForms.Controls.LocLabelEx DomainLabel;
		private System.Windows.Forms.ComboBox DomainDropDown;
		private Pixtro.WinForms.Controls.LocLabelEx SizeLabel;
		private System.Windows.Forms.ComboBox SizeDropDown;
		private Pixtro.WinForms.Controls.LocLabelEx DisplayTypeLabel;
		...
		private Pixtro.WinForms.Controls.LocLabelEx CompareTypeLabel;
	}
}
