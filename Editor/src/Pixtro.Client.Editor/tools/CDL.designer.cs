...
namespace Pixtro.Client.Editor
{
	partial class CDL
	{
		...
		private void InitializeComponent()
		{
			...
			this.miAutoStart = new Pixtro.WinForms.Controls.ToolStripMenuItemEx();
			this.miAutoSave = new Pixtro.WinForms.Controls.ToolStripMenuItemEx();
			...
			this.DisassembleMenuItem = new Pixtro.WinForms.Controls.ToolStripMenuItemEx();
			...
			this.miAutoResume = new Pixtro.WinForms.Controls.ToolStripMenuItemEx();
		...
		private Pixtro.WinForms.Controls.ToolStripMenuItemEx DisassembleMenuItem;
		...
		private Pixtro.WinForms.Controls.ToolStripMenuItemEx miAutoStart;
		private Pixtro.WinForms.Controls.ToolStripMenuItemEx miAutoSave;
		private ToolStripEx toolStrip1;
		private Pixtro.WinForms.Controls.ToolStripMenuItemEx miAutoResume;
	}
}