...
namespace Pixtro.Client.Editor
{
	partial class GenericDebugger
	{
		...
		private void InitializeComponent()
		{
			...
			this.DebugSubMenu = new Pixtro.WinForms.Controls.ToolStripMenuItemEx();
			this.StepIntoMenuItem = new Pixtro.WinForms.Controls.ToolStripMenuItemEx();
			this.StepOverMenuItem = new Pixtro.WinForms.Controls.ToolStripMenuItemEx();
			this.StepOutMenuItem = new Pixtro.WinForms.Controls.ToolStripMenuItemEx();
			this.toolStripSeparator1 = new Pixtro.WinForms.Controls.ToolStripSeparatorEx();
			this.RefreshMenuItem = new Pixtro.WinForms.Controls.ToolStripMenuItemEx();
			this.RegistersGroupBox = new System.Windows.Forms.GroupBox();
			this.RegisterPanel = new Pixtro.Client.Editor.RegisterBoxControl();
			this.BreakpointsGroupBox = new System.Windows.Forms.GroupBox();
			this.BreakPointControl1 = new Pixtro.Client.Editor.BreakpointControl();
			...
			this.AddBreakpointContextMenuItem = new Pixtro.WinForms.Controls.ToolStripMenuItemEx();
			...
			this.SeekToBox = new Pixtro.Client.Editor.HexTextBox();
		...
		private Pixtro.WinForms.Controls.ToolStripMenuItemEx DebugSubMenu;
		private Pixtro.WinForms.Controls.ToolStripMenuItemEx StepIntoMenuItem;
		private Pixtro.WinForms.Controls.ToolStripMenuItemEx StepOverMenuItem;
		private Pixtro.WinForms.Controls.ToolStripMenuItemEx StepOutMenuItem;
		...
		private Pixtro.WinForms.Controls.ToolStripMenuItemEx RefreshMenuItem;
		private System.Windows.Forms.ContextMenuStrip DisassemblerContextMenu;
		private Pixtro.WinForms.Controls.ToolStripMenuItemEx AddBreakpointContextMenuItem;
