namespace Pixtro.Client.Editor
{
	partial class VirtualPadDiscManager
	{
		...
		private void InitializeComponent()
		{
			...
			this.btnClose = new Pixtro.Client.Editor.VirtualPadButton();
			this.btnOpen = new Pixtro.Client.Editor.VirtualPadButton();
			this.lblTimeZero = new Pixtro.WinForms.Controls.LocLabelEx();
		...
		private Pixtro.WinForms.Controls.LocLabelEx lblTimeZero;
	}
}
