namespace Pixtro.Client.Editor
{
    partial class RamPoke
    {
        ...
        private void InitializeComponent()
        {
			...
			this.OutputLabel = new Pixtro.WinForms.Controls.LocLabelEx();
			this.ValeLabel = new Pixtro.WinForms.Controls.LocLabelEx();
			this.ValueBox = new Pixtro.Client.Editor.WatchValueBox();
			this.ValueHexLabel = new Pixtro.WinForms.Controls.LocLabelEx();
			this.DisplayTypeLabel = new Pixtro.WinForms.Controls.LocLabelEx();
			this.SizeLabel = new Pixtro.WinForms.Controls.LocLabelEx();
			this.BigEndianLabel = new Pixtro.WinForms.Controls.LocLabelEx();
        ...
        private Pixtro.WinForms.Controls.LocLabelEx OutputLabel;
        private Pixtro.WinForms.Controls.LocLabelEx ValeLabel;
        private WatchValueBox ValueBox;
		private Pixtro.WinForms.Controls.LocLabelEx ValueHexLabel;
		private Pixtro.WinForms.Controls.LocLabelEx DisplayTypeLabel;
		private Pixtro.WinForms.Controls.LocLabelEx SizeLabel;
		private Pixtro.WinForms.Controls.LocLabelEx BigEndianLabel;
