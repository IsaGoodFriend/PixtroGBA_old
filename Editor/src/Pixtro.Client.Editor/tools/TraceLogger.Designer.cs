...
namespace Pixtro.Client.Editor
{
	partial class TraceLogger
	{
		...
		private void InitializeComponent()
		{
			...
			this.CopyContextMenu = new Pixtro.WinForms.Controls.ToolStripMenuItemEx();
			this.SelectAllContextMenu = new Pixtro.WinForms.Controls.ToolStripMenuItemEx();
			this.ClearContextMenu = new Pixtro.WinForms.Controls.ToolStripMenuItemEx();
			this.menuStrip1 = new MenuStripEx();
			this.FileSubMenu = new Pixtro.WinForms.Controls.ToolStripMenuItemEx();
			this.SaveLogMenuItem = new Pixtro.WinForms.Controls.ToolStripMenuItemEx();
			this.EditSubMenu = new Pixtro.WinForms.Controls.ToolStripMenuItemEx();
			...
			this.ClearMenuItem = new Pixtro.WinForms.Controls.ToolStripMenuItemEx();
			this.OptionsSubMenu = new Pixtro.WinForms.Controls.ToolStripMenuItemEx();
			this.MaxLinesMenuItem = new Pixtro.WinForms.Controls.ToolStripMenuItemEx();
			...
			this.SegmentSizeMenuItem = new Pixtro.WinForms.Controls.ToolStripMenuItemEx();
		...
		private Pixtro.WinForms.Controls.ToolStripMenuItemEx SaveLogMenuItem;
		...
		private Pixtro.WinForms.Controls.ToolStripMenuItemEx MaxLinesMenuItem;
		...
		private Pixtro.WinForms.Controls.ToolStripMenuItemEx EditSubMenu;
		...
		private Pixtro.WinForms.Controls.ToolStripMenuItemEx ClearMenuItem;
		private System.Windows.Forms.ContextMenuStrip TraceContextMenu;
		private Pixtro.WinForms.Controls.ToolStripMenuItemEx CopyContextMenu;
		private Pixtro.WinForms.Controls.ToolStripMenuItemEx SelectAllContextMenu;
		private Pixtro.WinForms.Controls.ToolStripMenuItemEx ClearContextMenu;
		private System.Windows.Forms.Button OpenLogFile;
		private Pixtro.WinForms.Controls.ToolStripMenuItemEx SegmentSizeMenuItem;
	}
}