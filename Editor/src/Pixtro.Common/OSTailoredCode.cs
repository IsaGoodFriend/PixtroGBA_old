...
#if EXE_PROJECT
namespace EXE_PROJECT // Use a different namespace so the executable can still use this class' members without an implicit dependency on the Pixtro.Common library, and without resorting to code duplication.
#else
