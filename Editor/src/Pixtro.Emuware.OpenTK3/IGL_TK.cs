...
using BizGL = Pixtro.Emuware.BizwareGL;
...
using Matrix4 = Pixtro.Emuware.BizwareGL.Matrix4;
using PrimitiveType = OpenTK.Graphics.OpenGL.PrimitiveType;
using sd = System.Drawing;
using sdi = System.Drawing.Imaging;
using swf = System.Windows.Forms;
using Vector2 = Pixtro.Emuware.BizwareGL.Vector2;
using Vector4 = Pixtro.Emuware.BizwareGL.Vector4;
using VertexAttribPointerType = OpenTK.Graphics.OpenGL.VertexAttribPointerType;

namespace Pixtro.Emuware.OpenTK3
{
	/// <summary>
