...
namespace Pixtro.Emuware.BizwareGL
{
	public class IGL_GdiPlus : IGL
	{
		...
		public void SetMinFilter(Texture2d texture, Emuware.BizwareGL.TextureMinFilter minFilter)
			=> ((GDIPTextureWrapper) texture.Opaque).MinFilter = minFilter;

		public void SetMagFilter(Texture2d texture, Emuware.BizwareGL.TextureMagFilter magFilter)
